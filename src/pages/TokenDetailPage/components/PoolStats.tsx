    ...
    >
      ...
      <div className="space-y-2.5">
        {stats.map((stat) => (
          <div key={stat.label} className="flex items-center justify-between">
            <span className="text-sm text-gray-400 font-sans">{stat.label}</span>
      ...
      <div className="mt-4 pt-3 border-t border-white/10">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-gray-300 font-mono">{attrs.name}</span>
        </div>
          ...
          <div className="flex flex-wrap gap-2">
            {websites.map((url, i) => (
              <a
                ...
                className="inline-flex items-center gap-1.5 text-xs text-gray-300 hover:text-white transition-colors duration-200 bg-white/5 hover:bg-white/10 px-3 min-h-[44px] rounded-lg cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500/30"
              >
            ...
            {socials?.twitter_handle && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 text-xs text-[#1DA1F2] hover:text-[#1a8cd8] transition-colors duration-200 bg-[#1DA1F2]/10 hover:bg-[#1DA1F2]/20 px-3 min-h-[44px] rounded-lg cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#1DA1F2]/50"
              >
            ...
            {socials?.telegram_handle && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 text-xs text-[#26A5E4] hover:text-[#229ED9] transition-colors duration-200 bg-[#26A5E4]/10 hover:bg-[#26A5E4]/20 px-3 min-h-[44px] rounded-lg cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#26A5E4]/50"
              >
                <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
            ...
            {socials?.discord_url && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 text-xs text-[#5865F2] hover:text-[#4752C4] transition-colors duration-200 bg-[#5865F2]/10 hover:bg-[#5865F2]/20 px-3 min-h-[44px] rounded-lg cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#5865F2]/50"
              >
                <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
