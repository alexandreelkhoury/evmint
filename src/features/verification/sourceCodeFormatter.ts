/**
 * Source code formatting utilities for contract verification
 */

/**
 * Get the flattened source code for MyERC20 contract
 ...
 */
export function getMyERC20SourceCode(): string {
  const sourceCode = `
