        ...
        <div className="text-center">
          ...
          <div className="flex gap-3">
            <motion.button
              ...
              disabled={isPending}
              className="flex-1 py-3 px-4 bg-blue-600 text-white font-semibold rounded-xl transition-[background-color,color,border-color,box-shadow,opacity] duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isPending ? (
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={handleDismiss}
              className="flex-1 py-3 px-4 bg-white/10 border border-white/20 text-white font-medium rounded-xl hover:bg-white/15 transition-[background-color,color,border-color,box-shadow,opacity] duration-200"
            >
              Later
            </motion.button>
          </div>
